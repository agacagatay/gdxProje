...
public class SplashScreen implements Screen {
	...
	public void show() {
		...
		codelabsImage.addAction(Actions.sequence(Actions.fadeIn(0.25f), Actions
				.delay(0.25f, Actions.fadeOut(0.25f))));
		...
		githubImage.addAction(Actions.delay(0.75f, Actions.sequence(Actions.fadeIn(0.25f), Actions
				.delay(0.25f, Actions.moveBy(0,
						-(height - githubImage.getHeight() / 2), 0.5f,
