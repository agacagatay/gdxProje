package grafikod.ders.view;

 
import grafikod.ders.model.Block;
import grafikod.ders.model.Bob;
import grafikod.ders.model.Bob.State;
import grafikod.ders.model.World;
...
public class WorldRenderer {
	...
	public WorldRenderer(World world, boolean debug) {
		this.world = world;
		this.cam = new OrthographicCamera(CAMERA_WIDTH*3, CAMERA_HEIGHT*3);
